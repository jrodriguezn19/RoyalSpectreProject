...
var ExternalApiComponent = /** @class */ (function () {
    function ExternalApiComponent(api, http) {
        this.api = api;
        this.http = http;
    ...
    ExternalApiComponent.prototype.postImage = function () {
        ...
        this.http.post('https://us-central1-royalspectreproject.cloudfunctions.net/uploadFile', fd).subscribe(function (res) {
            console.log(res);
            alert("Post Complete");
        });
    };
    ...
    ExternalApiComponent.prototype.onUpload = function () {
        console.log("uploading");
        var fd = new FormData();
        fd.append('Testing', this.selectedFile, this.selectedFile.name);
...
var ProfileComponent = /** @class */ (function () {
    ...
    ProfileComponent.prototype.newProject = function () {
    ...
    ProfileComponent.prototype.CreateProject = function () {
        var fileName = 'Hi Ivan.jpg';
