...
let ProfileAnonymousComponent = class ProfileAnonymousComponent {
    ...
    getProject() {
        axios__WEBPACK_IMPORTED_MODULE_4___default.a.post('http://localhost:8000/projectUser', { id_user: this.id })
            .then((projectData) => {
            this.projects = projectData.data.projects;
            this.projectsUpdated.next([...this.projects]);
            console.log(this.projects);
    ...
    getUser() {
        axios__WEBPACK_IMPORTED_MODULE_4___default.a.post('http://localhost:8000/detailUser', { id_user: this.id })
            .then(userData => {
...
ProfileAnonymousComponent.ctorParameters = () => [
...
let ProfileComponent = class ProfileComponent {
    ...
    DeleteProject(id_project) {
        axios__WEBPACK_IMPORTED_MODULE_3___default.a.post('http://localhost:8000/deleteProject', { id_project: id_project })
            .then(document => {
