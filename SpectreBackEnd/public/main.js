...
const routes = [
    ...
    { path: 'profile/:id', component: _profile_profile_component__WEBPACK_IMPORTED_MODULE_6__["ProfileComponent"], canActivate: [_auth_guard__WEBPACK_IMPORTED_MODULE_7__["AuthGuard"]] },
...
let ExternalApiComponent = class ExternalApiComponent {
    ...
    uploadFile(event) {
        ...
        task.snapshotChanges().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["finalize"])(() => this.downloadURL = fileRef.getDownloadURL()))
            .subscribe();
    }
    ngOnInit() {
    }
...
let MainMenuComponent = class MainMenuComponent {
    ...
    getProjectSortNewest() {
        ...
        axios__WEBPACK_IMPORTED_MODULE_3___default.a.get('http://localhost:8000/projectNewest')
            .then((projectData) => {
    ...
    getProjectSortPopular() {
        ...
        //alert("Setup to " + localStorage.getItem('sortBy'));
        axios__WEBPACK_IMPORTED_MODULE_3___default.a.get('http://localhost:8000/projectPopular')
            .then((projectData) => {
            this.projects = projectData.data.projects;
            this.projectsUpdated.next([...this.projects]);
            console.log(this.projects);
...
let ProfileComponent = class ProfileComponent {
    ...
    ngOnInit() {
        ...
        axios__WEBPACK_IMPORTED_MODULE_3___default.a.post('http://localhost:8000/projectUser', { id_user: this.id })
            .then((projectData) => {
            this.projects = projectData.data.projects;
            this.projectsUpdated.next([...this.projects]);
            console.log(this.projects);
    ...
    CreateProject(id_user, user_name, photo_profile) {
        let fileName = 'uio';
        let ext = this.selectedFile.name.split('.')[1];
        const fd = new FormData();
        let that = this;
        axios__WEBPACK_IMPORTED_MODULE_3___default.a.post('http://localhost:8000/imageName')
            .then(function (response) {
            ...
            axios__WEBPACK_IMPORTED_MODULE_3___default.a.post('http://localhost:8000/createProject', { user_name: user_name, photo_profile: photo_profile, id_user: id_user, target_fund: that.target_fund, status: that.status, image_url: url })
                .then(function (response) {
                console.log(response.data['message']);
            })
                .catch(function (error) {
...
let ProjectDetailComponent = class ProjectDetailComponent {
    ...
    ngOnInit() {
        //#1 start
        this.router.events.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["filter"])((event) => event instanceof _angular_router__WEBPACK_IMPORTED_MODULE_2__["NavigationEnd"])).subscribe(() => {
    ...
    getDetailProject() {
        let that = this;
        axios__WEBPACK_IMPORTED_MODULE_4___default.a.post('http://localhost:8000/selectedProject', { id_project: this.id })
            .then(function (response) {
            console.log(response.data['message']);
    ...
    //sendComment
    getComment() {
        axios__WEBPACK_IMPORTED_MODULE_4___default.a.post('http://localhost:8000/retrieveComments', { id_project: this.id })
            .then((commentData) => {
    ...
    DeleteComment(id_comment) {
        //deleteComment
        axios__WEBPACK_IMPORTED_MODULE_4___default.a.post('http://localhost:8000/deleteComment', { id_comment: id_comment })
            .then(function (response) {
            console.log(response.data['message']);
            location.reload();
        })
    ...
    SendReact(id_user, user_name, profile_picture, react) {
        ...
        axios__WEBPACK_IMPORTED_MODULE_4___default.a.post('http://localhost:8000/sendComment', { id_user: id_user, typeReact: react, id_project: this.project[0]._id, user_name: user_name, image_url: url, profile_picture: profile_picture })
            .then(function (response) {
            console.log(response.data['message']);
            location.reload();
        })
    ...
    SendComment(id_user, user_name, profile_picture) {
        ...
        const fd = new FormData();
        let that = this;
        axios__WEBPACK_IMPORTED_MODULE_4___default.a.post('http://localhost:8000/imageName')
            .then(function (response) {
            fileName = response.data + '.' + ext;
            let url = 'https://firebasestorage.googleapis.com/v0/b/royalspectreproject.appspot.com/o/' + fileName + '?alt=media&token=57f0fd2a-30f4-469c-8371-d30e66a47975';
            fd.append('Testing', that.selectedFile, fileName);
            axios__WEBPACK_IMPORTED_MODULE_4___default.a.post('https://us-central1-royalspectreproject.cloudfunctions.net/uploadFile', fd).then(res => {
                console.log(res);
                location.reload();
            });
            axios__WEBPACK_IMPORTED_MODULE_4___default.a.post('http://localhost:8000/sendComment', { id_user: id_user, typeReact: 0, id_project: that.project[0]._id, user_name: user_name, image_url: url, profile_picture: profile_picture })
                .then(function (response) {
                console.log(response.data['message']);
            })
                .catch(function (error) {
...
let SideMenuComponent = class SideMenuComponent {
    ...
    ngOnInit() {
        ...
        axios__WEBPACK_IMPORTED_MODULE_3___default.a.get('http://localhost:8000/projectPopularSideMenu')
            .then((projectData) => {
            this.projects = projectData.data.projects;
            this.projectsUpdated.next([...this.projects]);
            console.log(this.projects);
        });
        axios__WEBPACK_IMPORTED_MODULE_3___default.a.get('http://localhost:8000/peoplePopularSideMenu')
            .then((userData) => {
